...
class CollectionUtilTests {
  ...
  def test_split() {
    ...
    assertEqualsIterator(Iterator(Vector(1, 2, 3, 4, 5)), Vector(1, 2, 3, 4, 5).split(9, true, true))
    assertEqualsIterator(Iterator(Vector(1, 2, 3, 4, 5)), Iterator(1, 2, 3, 4, 5).split(9, true, true))
    assertEqualsIterator(Iterator(Vector(1, 2, 3, 4, 5)), Vector(1, 2, 3, 4, 5).split(9, true, false))
    assertEqualsIterator(Iterator(Vector(1, 2, 3, 4, 5)), Iterator(1, 2, 3, 4, 5).split(9, true, false))

    // "12345".split('3')  -->  Array(12, 45)
    assertEqualsIterator(Iterator(List(1, 2), List(4, 5)), List(1, 2, 3, 4, 5).split(3))
    assertEqualsIterator(Iterator(Set(1, 2), Set(4, 5)), Iterator(1, 2, 3, 4, 5).split(3, Set.newBuilder[Int], false, true))
    assertEqualsIterator(Iterator(List(1, 2), List(3, 4, 5)), List(1, 2, 3, 4, 5).split(3, true, true))
    assertEqualsIterator(Iterator(Set(1, 2), Set(3, 4, 5)), Iterator(1, 2, 3, 4, 5).split(3, Set.newBuilder[Int], true, true))
    assertEqualsIterator(Iterator(List(1, 2, 3), List(4, 5)), List(1, 2, 3, 4, 5).split(3, true, false))
    assertEqualsIterator(Iterator(Set(1, 2, 3), Set(4, 5)), Iterator(1, 2, 3, 4, 5).split(3, Set.newBuilder[Int], true, false))
    ...
    assertEqualsIterator(Iterator(Vector(1), Vector(2, 3, 4), Vector(2), Vector(2, 5)), Vector(1, 2, 3, 4, 2, 2, 5).split(2, true, true))
    assertEqualsIterator(Iterator(Vector(1), Vector(2, 3, 4), Vector(2), Vector(2, 5)), Iterator(1, 2, 3, 4, 2, 2, 5).split(2, true, true))
    assertEqualsIterator(Iterator(Vector(1, 2), Vector(3, 4, 2), Vector(2), Vector(5)), Vector(1, 2, 3, 4, 2, 2, 5).split(2, true, false))
    assertEqualsIterator(Iterator(Vector(1, 2), Vector(3, 4, 2), Vector(2), Vector(5)), Iterator(1, 2, 3, 4, 2, 2, 5).split(2, true, false))
    ...
    assertEqualsIterator(Iterator(Vector(), Vector(2, 1), Vector(2, 3, 4), Vector(2), Vector(2), Vector(2, 5)), Vector(2, 1, 2, 3, 4, 2, 2, 2, 5).split(2, true, true))
    assertEqualsIterator(Iterator(Vector(), Vector(2, 1), Vector(2, 3, 4), Vector(2), Vector(2), Vector(2, 5)), Iterator(2, 1, 2, 3, 4, 2, 2, 2, 5).split(2, true, true))
    assertEqualsIterator(Iterator(Vector(2), Vector(1, 2), Vector(3, 4, 2), Vector(2), Vector(2), Vector(5)), Vector(2, 1, 2, 3, 4, 2, 2, 2, 5).split(2, true, false))
    assertEqualsIterator(Iterator(Vector(2), Vector(1, 2), Vector(3, 4, 2), Vector(2), Vector(2), Vector(5)), Iterator(2, 1, 2, 3, 4, 2, 2, 2, 5).split(2, true, false))
    ...
    assertEqualsIterator(Iterator(Vector(), Vector(2), Vector(2, 1), Vector(2, 3, 4), Vector(2), Vector(2, 5)), Vector(2, 2, 1, 2, 3, 4, 2, 2, 5).split(2, true, true))
    assertEqualsIterator(Iterator(Vector(), Vector(2), Vector(2, 1), Vector(2, 3, 4), Vector(2), Vector(2, 5)), Iterator(2, 2, 1, 2, 3, 4, 2, 2, 5).split(2, true, true))
    assertEqualsIterator(Iterator(Vector(2), Vector(2), Vector(1, 2), Vector(3, 4, 2), Vector(2), Vector(5)), Vector(2, 2, 1, 2, 3, 4, 2, 2, 5).split(2, true, false))
    assertEqualsIterator(Iterator(Vector(2), Vector(2), Vector(1, 2), Vector(3, 4, 2), Vector(2), Vector(5)), Iterator(2, 2, 1, 2, 3, 4, 2, 2, 5).split(2, true, false))
    ...
    assertEqualsIterator(Iterator(Vector(1), Vector(2, 3, 4), Vector(2), Vector(2, 5), Vector(2)), Vector(1, 2, 3, 4, 2, 2, 5, 2).split(2, true, true))
    assertEqualsIterator(Iterator(Vector(1), Vector(2, 3, 4), Vector(2), Vector(2, 5), Vector(2)), Iterator(1, 2, 3, 4, 2, 2, 5, 2).split(2, true, true))
    assertEqualsIterator(Iterator(Vector(1, 2), Vector(3, 4, 2), Vector(2), Vector(5, 2)), Vector(1, 2, 3, 4, 2, 2, 5, 2).split(2, true, false))
    assertEqualsIterator(Iterator(Vector(1, 2), Vector(3, 4, 2), Vector(2), Vector(5, 2)), Iterator(1, 2, 3, 4, 2, 2, 5, 2).split(2, true, false))
    ...
    assertEqualsIterator(Iterator(Vector(1), Vector(2, 3, 4), Vector(2), Vector(2, 5), Vector(2), Vector(2)), Vector(1, 2, 3, 4, 2, 2, 5, 2, 2).split(2, true, true))
    assertEqualsIterator(Iterator(Vector(1), Vector(2, 3, 4), Vector(2), Vector(2, 5), Vector(2), Vector(2)), Iterator(1, 2, 3, 4, 2, 2, 5, 2, 2).split(2, true, true))
    assertEqualsIterator(Iterator(Vector(1, 2), Vector(3, 4, 2), Vector(2), Vector(5, 2), Vector(2)), Vector(1, 2, 3, 4, 2, 2, 5, 2, 2).split(2, true, false))
    assertEqualsIterator(Iterator(Vector(1, 2), Vector(3, 4, 2), Vector(2), Vector(5, 2), Vector(2)), Iterator(1, 2, 3, 4, 2, 2, 5, 2, 2).split(2, true, false))
    ...
    assertEqualsIterator(Iterator(Vector(1), Vector(2, 3, 4), Vector(2), Vector(2, 5), Vector(2), Vector(2), Vector(2)), Vector(1, 2, 3, 4, 2, 2, 5, 2, 2, 2).split(2, true, true))
    assertEqualsIterator(Iterator(Vector(1), Vector(2, 3, 4), Vector(2), Vector(2, 5), Vector(2), Vector(2), Vector(2)), Iterator(1, 2, 3, 4, 2, 2, 5, 2, 2, 2).split(2, true, true))
    assertEqualsIterator(Iterator(Vector(1, 2), Vector(3, 4, 2), Vector(2), Vector(5, 2), Vector(2), Vector(2)), Vector(1, 2, 3, 4, 2, 2, 5, 2, 2, 2).split(2, true, false))
    assertEqualsIterator(Iterator(Vector(1, 2), Vector(3, 4, 2), Vector(2), Vector(5, 2), Vector(2), Vector(2)), Iterator(1, 2, 3, 4, 2, 2, 5, 2, 2, 2).split(2, true, false))
  }
